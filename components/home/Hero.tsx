          ...
          >
            <div className="text-left lg:text-left text-center max-w-2xl mx-auto lg:mx-0">
              ...
              >
                <Link
                  href="/preturi"
                  className="inline-flex items-center justify-center px-2.5 py-4 lg:px-6 lg:py-3 bg-gradient-red text-white font-semibold rounded-lg hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl text-xs lg:text-sm sm:text-base"
                >
                  Vezi ofertă
                ...
                <a
                  href="tel:0764421141"
                  className="inline-flex items-center justify-center px-2.5 py-4 lg:px-6 lg:py-3 border-2 border-primary text-primary bg-white/10 backdrop-blur-sm font-semibold rounded-lg hover:bg-primary hover:text-white transition-colors text-xs lg:text-sm sm:text-base"
                >
                  Sună acum
                </a>
              </motion.div>
